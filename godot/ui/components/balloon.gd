...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		var _position = target.global_position if target else Vector2(0, 0)
		dialogue_label.global_position = _position - Vector2(dialogue_label.size.x * 0.5, dialogue_label.get_content_height())
